      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the failure type.</p>
          </div>
        </div>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-2 gap-6">
                  ...
                  <div class="col-span-6 lg:col-span-3">
                    <base-input
                        :id="'code-failure-type'"
                        :autocomplete="'code-failure-type'"
                        v-model="failureType.code"
                        label="Code"
                        type="text"
                        :is-disabled="!canEdit"
                        :is-required="true"
                  ...
                  <div class="col-span-6 lg:col-span-3">
                    <base-input
                        ...
                        :autocomplete="'description-failure-type'"
                        v-model="failureType.description"
                        label="Description"
                        type="text"
                        :is-disabled="!canEdit"
                        :is-required="true"
...
const enableSave = computed(() => {
  return data.failureType.value.code
      && data.failureType.value.description
})

const sendData = (event) => {
  event.preventDefault()
  emit('save', {
    failure_type: data.failureType.value,
    status: selectedStatus.value.id,
  })
}

onBeforeMount( () => {
  if (data.failureType.value.id) {
    useSetInitialSelect(statuses.value, data.failureType.value.status, selectedStatus)
  } else {
