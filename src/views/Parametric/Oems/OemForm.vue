      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the OEM.</p>
          </div>
        </div>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <base-input
                        :id="'description-oem'"
                        :autocomplete="'description-oem'"
                        v-model="oem.description"
                        label="Description"
                        type="text"
                        :is-disabled="!canEdit"
                    />
...
const enableSave = computed(() => {
  return data.oem.value.code
      && data.oem.value.description
})
...
onBeforeMount(() => {
  if (data.oem.value.id) {
    useSetInitialSelect(statuses.value, data.oem.value.status, selectedStatus)
  } else {
