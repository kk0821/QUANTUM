      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the service type.</p>
          </div>
        </div>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <base-input
                        :id="'code-service-type'"
                        :autocomplete="'code-service-type'"
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <base-input
                        ...
                        :autocomplete="'description-service-type'"
...
function assignStatus() {
  if (data.assignList.value) {
    ...
    statuses.value.forEach((element, index) => {
      if (element.id === data.serviceType.value.status) {
...
const sendData = (event) => {
  ...
  emit('save', { service_type: data.serviceType.value, status: selectedStatus.value } )
}
</script>
