      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the service impacted.</p>
          </div>
        </div>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-5">
                    <base-input
                        :id="'service-impacted-name'"
                        :autocomplete="'service-impacted-name'"
                        v-model="impactedService.name"
                        label="Name"
                        type="text"
                        :is-disabled="!canEdit"
                    />
...
const enableSave = computed(() => {
  return data.impactedService.value.name
})

onBeforeMount(() => {
  if (data.impactedService.value.id) {
    useSetInitialSelect(statuses.value, data.impactedService.value.status, selectedStatus)
  } else {
...
const sendData = (event) => {
  ...
  emit('save', {
    impacted_service: data.impactedService.value,
