      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the controller Type.</p>
          </div>
        </div>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-5">
                    <base-input
                        :id="'name-controller-type'"
                        :autocomplete="'name-controller-type'"
                        v-model="controllerType.name"
                        label="Name"
                        type="text"
                        :is-disabled="!canEdit"
                    />
                  ...
                  <div class="col-span-6 sm:col-span-3 lg:col-span-3" v-if="controllerType.id">
...
onBeforeMount(() => {
  if (data.controllerType.value.id) {
    statuses.value.forEach((element) => {
      if (element.id === data.controllerType.value.status) {
...
const sendData = (event) => {
  ...
  emit('save', {
    controllerType: data.controllerType.value,
