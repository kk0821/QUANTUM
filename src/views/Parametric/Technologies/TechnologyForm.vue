      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the technology.</p>
          </div>
        </div>
                ...
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-5">
                    <base-input
                        ...
                        :autocomplete="'description-technology'"
...
function assignStatus() {
  if (data.assignList.value) {
    ...
    statuses.value.forEach((element, index) => {
      if (element.id === data.technology.value.status) {
...
const sendData = (event) => {
  ...
  emit('save', { technology: data.technology.value, status: selectedStatus.value } )
}
</script>
