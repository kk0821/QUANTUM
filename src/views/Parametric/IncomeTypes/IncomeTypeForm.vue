      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            ...
            <p class="mt-1 text-sm text-gray-600">Descriptive information of the income type.</p>
          </div>
        </div>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-2 gap-6">
                  ...
                  <div class="col-span-6 lg:col-span-3">
                    <base-input
                        :id="'code-income-type'"
                        :autocomplete="'code-income-type'"
                        v-model="incomeType.code"
                        label="Code"
                        type="text"
                        :is-disabled="!canEdit"
                        :is-required="true"
                  ...
                  <div class="col-span-6 lg:col-span-3">
                    <base-input
                        :id="'description-income-type'"
                        :autocomplete="'description-income-type'"
...
const enableSave = computed(() => {
  return data.incomeType.value.code
      && data.incomeType.value.description
})
...
onBeforeMount( () => {
  if (data.incomeType.value.id) {
    useSetInitialSelect(statuses.value, data.incomeType.value.status, selectedStatus)
  } else {
