    ...
    <div v-show="!loading.state" class="px-4 py-4 sm:px-6 lg:px-8">
      <div class="mx-auto">
        ...
        <div class="pb-5 border-b border-gray-200">
          <h1 class="text-2xl font-semibold text-gray-900 pt-4">{{cityName}}</h1>
        </div>
      </div>
      <div class="mx-auto">
        <CitySourceForm
            v-if="citySourceData.id"
...
const trace = [
  ...
  { description: 'Edit', pathName: 'CitySourceEdit', isLink: false, current: true }
]
onBeforeMount( () => {
...
const saveData = (event) => {
  ...
  citySourceService.save(route.params.citySourceId, payload)
    .then(x => {
